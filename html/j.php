...
>
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item open">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="posted-assingments.html" class="menu-link">
                    <div data-i18n="Posted">Posted</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="accepted-assingments.html" class="menu-link">
                    <div data-i18n="Accepted">Accepted</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="done-assingments.html" class="menu-link">
                    <div data-i18n="Container">Done</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="submitted-assingments.html" class="menu-link">
                    <div data-i18n="Submitted">Submitted</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="paid-assingments.html" class="menu-link">
    ...
    ?> <?php echo $admin['firstname'] ?>! ??</h5>
                          <p class="mb-4">
                            You have <span class="fw-bold">72</span> pending assingments.
                          </p>

                          <a href="javascript:;" class="btn btn-sm btn-outline-primary">View Assingments</a>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title mb-2">72</h3>
                          <small class="text-danger fw-semibold"> 1 by 17 May 8am</small>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <ul class="p-0 m-0">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <span class="avatar-initial rounded bg-label-warning"><i class="bx bx-down-arrow-alt bx-fade-down"></i></span>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              <h6 class="mb-0">Done</h6>
                              <small class="text-muted">Through. Not submited</small>
                            </div>
                            <div class="user-progress">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              ...
                              <small class="text-muted">Approved by client</small>
                            </div>
                            <div class="user-progress">
