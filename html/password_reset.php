...
>
  <head>
    ...
    <title>Change Password - Expert Writers</title>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="password_new.php?code=<?php echo $_GET['code']; ?>&user=<?php echo $_GET['user']; ?>" method="POST">
                ...
                <button class="btn btn-primary d-grid w-100" type="submit" name="reset">Change Password</button>
              </form>
              <div class="text-center text-danger">
                <a href="index" class="d-flex align-items-center justify-content-center text-danger">
