...
>
  <head>
    ...
    <title>Login | Expert Writers</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Expert Writers! 👋</h4>
              <p class="mb-4">Please sign-in to your account to begin your session</p>

              <form id="formAuthentication" class="mb-3" action="verify.php" method="POST">
                <div class="mb-3">
