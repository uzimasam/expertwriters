        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="achange.php" method="POST">
                ...
                <button type="submit" name="tof" class="btn btn-primary d-grid w-100">Change Password</button>
              </form>
              <div class="text-center text-danger">
                <a href="admin" class="d-flex align-items-center justify-content-center text-danger">
