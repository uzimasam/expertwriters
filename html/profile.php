...
>
  <head>
    ...
    <title><?php echo $user['firstname'].' '.$user['lastname']?> - Account | Expert Writers</title>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <!-- Account -->
                    <form enctype="multipart/form-data" id="formAccountSettings" action="profileedit.php" method="POST">
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                              <button name="edit" class="btn btn-primary me-2">Save changes</button>
