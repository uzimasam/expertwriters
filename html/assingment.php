<?php 
  ...
  if(isset($_GET['key'])){
        $aid=$_GET['key'];
        $cid = $user['id'];
        $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM kazi WHERE id=:aid AND cid=:cid");
        $stmt->execute(['aid'=>$aid, 'cid'=>$cid]);
        $urow =  $stmt->fetch();
        if($urow['numrows']!=1){
            header('location: upload');
            $_SESSION['error'] = 'You are prohibited from viewing the assingment';
        }
  }
  else{
		$_SESSION['error'] = 'Select assingment to view';
        header('location: upload');
  }
?>
<!DOCTYPE html>
...
>
  <head>
    ...
    <title>View Assingment | Expert Writers</title>
                  ...
                  <div class="nav-align-top mb-4">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade show active" id="navs-justified-home" role="tabpanel">
                        <div class="list-group">
                          ...
                          >
                            ...
                            <p class="mb-1">
                              The assingment due date is <?php echo date('d M Y', strtotime($arrow['Duetime']))?> at <?php echo date('h:i a', strtotime($arrow['Duetime']))?>.
                            </p>
                            ...
                            if($arrow['status']>1){
                              echo'
                                ...
                                >
                                  ...
                                  <p class="mb-1">
                                    Your assingment costs '.number_format_short($arrow['Amount'], 2).' USD
                                  </p>
                                  <small>Paying details will be sent to you upon job completion.</small>
                                </a>
                              ';
                            }
                            if($arrow['status']>2){
                              echo'
                                ...
                                >
                                  ...
                                  <p class="mb-1">
                                    You assingment has been completed successfully
                                  </p>
                                  <small>Check your e-mail --->'.$user['email'].'<--- for futher details</small>
                                </a>
                              ';
                              if($arrow['flow']!=0){
                                echo'
                                  ...
                                  >
                                    ...
                                    <p class="mb-1">
                                      Your payment of USD 23.00 has been received.
                                    </p>
                                    <small>Check your e-mail --->'.$user['email'].'<--- to access the work done</small>
                                  </a>
                                ';
                              }
                            }
                            if($arrow['status']>3){
                              echo'
                                ...
                                >
                                  ...
                                  <p class="mb-1">
                                    You have reviewed the work done.
                                  </p>
                                  <small>Your rating is 3stars</small>
                                </a>
                                <a
                                  href="javascript:void(0);"
                                  class="list-group-item list-group-item-action flex-column align-items-start"
                                >
                                  ...
                                  <p class="mb-1">
                                    The writing process for your assingment is done.
                                  </p>
                                  <small>It has been nice working with you.</small>
                                </a>
                              ';
                            }
                          ?>
                                                    ...
                                                    <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Submitted Work</label>
                                                      <div class="col-sm-10 alert d-flex flex-wrap alert-dark" id="icons-container" role="alert">
                                                        ...
                                                        if($arrow['flow']!=0){
                                                          ...
                                                          echo"
                                                          Kindly complete payment to view files for the work done
                                                          ";
                                                        }
                                              ?>
                                              </div>
                      ...
                      <div class="tab-pane fade" id="navs-justified-messages" role="tabpanel">
                        <?php 
                            ...
                            foreach($stmt as $yrow){
                                echo '
                                    <div class="row">
                                        <div class="col-1"></div>
                                        <div class="col-8 pull-right alert alert-primary" role="alert">'.$yrow['notes'].'</div>
                                        <div class="col-1"></div>
                        ...
                        ?>
                        <form method="POST" action="asschat.php">
                          <div class="input-group">
                            <input
                              ...
                              required
                              class="form-control"
                              placeholder="Type message to your writer..."
                              aria-label="Type message to your writer..."
