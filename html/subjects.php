          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Admin /</span> Subjects
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <!-- Notifications -->
                    <h5 class="card-header">Subjects we offer</h5>
                    <div class="table-responsive">
                      <table class="table table-striped table-borderless border-bottom">
                        ...
                        <tbody>
                          <?php
                            $stmt = $conn->prepare("SELECT * FROM subjects WHERE id!=5");
                            $stmt->execute();
                            foreach($stmt as $urow){
                                echo '
                                    <tr>
                                        <td class="text-nowrap">'.$urow['id'].'</td>
                                        <td class="text-nowrap">'.$urow['subject'].'</td>
                                    </tr>
                                ';
                            }
                        ?>
                    ...
                    <div class="card-body">
                      <h6>Add other subjects to display;</h6>
                        ...
                        <div class="row">
                          <div class="mt-4">
                            <div class="input-group">
                                ...
                                />
                                <button class="btn btn-outline-primary" name="subad" type="submit">Add Subject</button>
                                <button class="btn btn-outline-danger" type="reset">Discard</button>
                            </div>
                          </div>
                        </div>
                      </form>
