...
>
  <head>
    ...
    <title> Jobs - Expert Writers</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">EW /</span> Jobs Submitted For Review</h4>
                                  ...
                                  <table class="table table-hover table-bordered">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ';$conn = $pdo->open();
                                            try{
                                                $no = 1;
                                                $stmt = $conn->prepare("SELECT * FROM kazi WHERE status=3 and cid !=0");
                                                $stmt->execute();
                                                foreach($stmt as $row){
                                                    $sub = $row['Subject'];
