...
>
  <head>
    ...
    <title>Forgot Password | Expert Writers</title>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Enter email associated with account and we'll send you a password reset link</p>
              <form id="formAuthentication" class="mb-3" action="resetaction.php" method="POST">
                <div class="mb-3">
                ...
                <button type="submit" name="reset" class="btn btn-primary d-grid w-100">Send Reset Link</button>
              </form>
