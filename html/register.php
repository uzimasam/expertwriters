...
>
  <head>
    ...
    <title>Register | Expert Writers</title>
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container" id="alrt">
                    ...
                    <div class="card-body">
                      ...
                      <div class="app-brand justify-content-center">
                        <a href="#" class="app-brand-link gap-2">
                          ...
                          <span class="app-brand-text demo text-body fw-bolder">Expert Writers</span>
                        </a>
                      </div>
                      <!-- /Logo -->
                      <h4 class="mb-2">Success starts here 🚀</h4>
                      <p class="mb-4">Get quality grades and your assingments done on time</p>

                      <form id="formAuthentication" class="mb-3"  action="registerdata.php" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="timezone" name="timezone" placeholder="Enter your timezone" />
                        </div>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="terms-conditions" value="true" checked name="terms" />
