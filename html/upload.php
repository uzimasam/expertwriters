...
>
  <head>
    ...
    <title>Upload Assingment | Expert Writers</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">EW /</span> Upload New Assingment</h4>


                  <!-- HTML5 Inputs -->
                  <div class="card mb-4">
                    <h5 class="card-header">Upload Section</h5>
                    <form action="submitkazi.php" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                          <div class="mb-3 row">
                            <label for="title" class="col-md-2 col-form-label">Assingment Title</label>
                            <div class="col-md-10">
                              <input class="form-control" type="text" placeholder="Introduction to Logic" id="title" name="title"/>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    <select class="form-select" type="text" id="subject" name="subject">
                                        ...
                                        <?php
                                            ...
                                            foreach($stmt as $urow){
                                                echo '
                                                    <option value="'.$urow['id'].'">'.$urow['subject'].'</option>
                                                ';
                                            }
                                        ?>
                          ...
                          <div class="mb-3 row">
                            <label for="links" class="col-md-2 col-form-label">Attach Links</label>
                            <div class="col-md-10">
                              <input
                                class="form-control"
                                type="url"
                                placeholder="https://example.com , https://expertwriters.com "
                                id="links"
                                name="links"
                              />
                            </div>
                          ...
                          <div class="mb-3 row">
                            <label for="duetime" class="col-md-2 col-form-label">Due Time</label>
                            <div class="col-md-10">
                              <input
                                class="form-control"
                                required
                                type="datetime-local"
                                placeholder="2022-06-18T12:30:00"
                                id="duetime"
                                name="duetime"
                              />
                            </div>
                          ...
                          <div class="mb-3 row">
                            <label for="attachments" class="col-md-2 col-form-label">Attach Files</label>
                            <div class="col-md-10">
                                <input class="form-control" type="file" id="attachments" name="attachments[]" multiple />
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="notes" class="col-md-2 col-form-label">Notes to the writer</label>
                            <div class="col-md-10">
                          ...
                          <div class="card-footer row justify-content-end">
                            <div class="col-sm-6">
                                <button type="submit" name="kazi" class="btn btn-primary">Upload</button>
                            </div>
                            <div class="col-sm-4">
            ...
            <?php
                ...
                if($su['numrows']!=0){
                    echo'
                        <div class="container-xxl flex-grow-1 container-p-y">
                          <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">EW /</span> Recent Uploads</h4>
                                                        ...
                                                        <td>
                                                            <div class='dropdown'>
                                                                ...
                                                                <div class='dropdown-menu'>
                                                                    <a class='dropdown-item' href='assingment?key=".$row['id']."'>
