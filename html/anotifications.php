      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item open">
              <a href="assingments" class="menu-link menu-toggle">
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link" href="aprofile"
                  ...
                  <div class="card">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-borderless border-bottom">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-nowrap">After uploading assingment</td>
                            <td>
                          ...
                          <tr>
                            <td class="text-nowrap">When my assingment has been completed</td>
                            <td>
                              <div class="form-check d-flex justify-content-center">
                          ...
                          <tr>
                            <td class="text-nowrap">After a successful transaction</td>
                            <td>
                              <div class="form-check d-flex justify-content-center">
